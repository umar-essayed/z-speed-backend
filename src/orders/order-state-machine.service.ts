...
export class OrderStateMachineService {
  private readonly allowedTransitions: Record<OrderStatus, OrderStatus[]> = {
    ...
    [OrderStatus.CONFIRMED]: [OrderStatus.PREPARING, OrderStatus.READY, OrderStatus.PICKED_UP, OrderStatus.CANCELLED],
    [OrderStatus.PREPARING]: [OrderStatus.READY, OrderStatus.PICKED_UP, OrderStatus.CANCELLED],
    [OrderStatus.READY]: [OrderStatus.READY_FOR_PICKUP, OrderStatus.PICKED_UP, OrderStatus.OUT_FOR_DELIVERY],
