...
export class OrderStateMachineService {
  private readonly allowedTransitions: Record<OrderStatus, OrderStatus[]> = {
    ...
    [OrderStatus.CONFIRMED]: [OrderStatus.PREPARING, OrderStatus.READY, OrderStatus.PICKED_UP, OrderStatus.ARRIVED, OrderStatus.CANCELLED],
    [OrderStatus.PREPARING]: [OrderStatus.READY, OrderStatus.PICKED_UP, OrderStatus.ARRIVED, OrderStatus.CANCELLED],
    [OrderStatus.READY]: [OrderStatus.READY_FOR_PICKUP, OrderStatus.PICKED_UP, OrderStatus.ARRIVED, OrderStatus.OUT_FOR_DELIVERY],
    [OrderStatus.READY_FOR_PICKUP]: [OrderStatus.PICKED_UP, OrderStatus.ARRIVED, OrderStatus.OUT_FOR_DELIVERY],
    [OrderStatus.PICKED_UP]: [OrderStatus.OUT_FOR_DELIVERY, OrderStatus.IN_TRANSIT, OrderStatus.ARRIVED, OrderStatus.DELIVERED],
    [OrderStatus.IN_TRANSIT]: [OrderStatus.ARRIVED, OrderStatus.DELIVERED],
    [OrderStatus.ARRIVED]: [OrderStatus.PICKED_UP, OrderStatus.OUT_FOR_DELIVERY, OrderStatus.DELIVERED],
    [OrderStatus.IN_PROGRESS]: [OrderStatus.OUT_FOR_DELIVERY, OrderStatus.CANCELLED],
    [OrderStatus.OUT_FOR_DELIVERY]: [OrderStatus.ARRIVED, OrderStatus.DELIVERED, OrderStatus.CANCELLED],
