...
export class OrderStateMachineService {
  private readonly allowedTransitions: Record<OrderStatus, OrderStatus[]> = {
    ...
    [OrderStatus.PICKED_UP]: [OrderStatus.OUT_FOR_DELIVERY, OrderStatus.IN_TRANSIT, OrderStatus.ARRIVED],
    [OrderStatus.IN_TRANSIT]: [OrderStatus.ARRIVED],
    [OrderStatus.ARRIVED]: [OrderStatus.DELIVERED],
    [OrderStatus.IN_PROGRESS]: [OrderStatus.OUT_FOR_DELIVERY, OrderStatus.ARRIVED, OrderStatus.DELIVERED, OrderStatus.CANCELLED],
